...
public class checkLeaveStatus extends javax.swing.JFrame {
    ...
    private String IC;
    private String ID;
    public checkLeaveStatus(Interface Server, empPage page, String LeaveBalance, String IC, String ID) {
        this.server = Server;
        this.page = page;
    ...
    private void generatePDF(String ID) {
        try {
            ...
            List<String[]> leaveRequests = server.getApprovedOrDeniedLeaveRequests(ID);
            ...
            table.addHeaderCell("Requested Days");
            ...
            for (String[] request : leaveRequests) {
                table.addCell(request[0]); // Employee ID
                table.addCell(request[1]); // Commencement Date
                table.addCell(request[4]); // Leave Days
                table.addCell(request[2]); // Status
                table.addCell(request[3]); // Creation Date
            }
